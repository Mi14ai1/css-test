...
var _menuInit = require("./modules/menu/menu-init.js");
var _rangeInit = require("./modules/range/range-init.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    form.init();
    window.form = form;
    (0, _rangeInit.rangeInit)();
    (0, _menuInit.menuInit)();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/input-file/init-upload":13,"./modules/menu/menu-init.js":16,"./modules/modals/init-modals":17,"./modules/range/range-init.js":19,"./modules/select/custom-select":21,"./utils/ios-vh-fix":24}],2:[function(require,module,exports){
"use strict";
...
},{"./helper":12}],12:[function(require,module,exports){
"use strict";
...
},{"./upload.js":15}],14:[function(require,module,exports){
"use strict";
...
},{"./create-message-markup":9,"./create-preview-container-markup":10,"./create-preview-markup":11,"./render":14}],16:[function(require,module,exports){
"use strict";
...
var _scrollLock = require("../../utils/scroll-lock.js");
var _focusLock = require("../../utils/focus-lock.js");
var menu = document.querySelector('.main-nav');
var burger = menu === null || menu === void 0 ? void 0 : menu.querySelector('.burger');
...
var pressEscHandler = function pressEscHandler(e) {
  if (e.key === 'Escape') {
    closeMenu();
  }
};
var toggleMenuHandler = function toggleMenuHandler() {
  var isOpen = menu.classList.contains('main-nav--menu-open');
...
},{"../../utils/focus-lock.js":22,"../../utils/scroll-lock.js":26}],17:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":26}],19:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.rangeInit = void 0;
...
var rangeInit = function rangeInit() {
  ...
  ranges.forEach(function (range) {
    var inputSlider = range.querySelector('.range__slider');
    var rangeValue = range.querySelector('.range__value');
    if (!inputSlider || !rangeValue) {
      return;
    }
    rangeValue.innerText = "".concat(inputSlider.value, " %");
